...
module Errors {
	...
	var r2arg1: new <T extends Base, U extends Derived, V extends Derived2>(
		x: new (arg: T) => U,
	) => new (r: T) => V;
	var r2arg2: new (
		x: new (arg: Base) => Derived,
	...
	var r3arg1: new <T extends Base, U extends Derived>(
		x: new (arg: T) => U,
		y: (arg2: { foo: number }) => U,
	) => new (r: T) => U;
	var r3arg2: new (
	...
	var r6arg2: new <T extends Array<Derived2>>(
		x: Array<Base>,
		y: Array<Base>,
	) => T;
