...
module TypeScript {
	...
	export class AstPath {
		...
		public ast() {
			return <TypeScript.AST>(
				AstPath.reverseIndexOf(
					this.asts,
					this.asts.length - (this.top + 1),
				)
			);
		}
		...
		public parent() {
			return <TypeScript.AST>(
				AstPath.reverseIndexOf(this.asts, this.asts.length - this.top)
			);
		}
		...
		public isNameOfClass(): boolean {
			...
			return (
				this.ast().nodeType === TypeScript.NodeType.Name &&
				this.parent().nodeType ===
					TypeScript.NodeType.ClassDeclaration &&
				(<TypeScript.InterfaceDeclaration>this.parent()).name ===
					this.ast()
			);
		}
		...
		public isNameOfModule(): boolean {
			...
			return (
				...
				(<TypeScript.ModuleDeclaration>this.parent()).name ===
					this.ast()
			);
		}
		...
		public isArgumentOfClassConstructor(): boolean {
			...
			return (
				...
				this.asts[this.top - 1].nodeType === TypeScript.NodeType.List &&
				this.asts[this.top - 2].nodeType ===
					TypeScript.NodeType.FuncDecl &&
				this.asts[this.top - 3].nodeType === TypeScript.NodeType.List &&
				this.asts[this.top - 4].nodeType ===
					TypeScript.NodeType.ClassDeclaration &&
				(<TypeScript.FuncDecl>this.asts[this.top - 2]).isConstructor &&
				(<TypeScript.FuncDecl>this.asts[this.top - 2]).arguments ===
					this.asts[this.top - 1] &&
				(<TypeScript.ClassDeclaration>this.asts[this.top - 4])
					.constructorDecl === this.asts[this.top - 2]
			);
		}
		...
		public isTopLevelImplicitModule() {
			return (
				this.count() >= 1 &&
				this.asts[this.top].nodeType ===
					TypeScript.NodeType.ModuleDeclaration &&
				TypeScript.hasFlag(
					(<TypeScript.ModuleDeclaration>this.asts[this.top])
						.modFlags,
					TypeScript.ModuleFlags.IsWholeFile,
				)
			);
		}
		...
		public isBodyOfTopLevelImplicitModule() {
			return (
				...
				this.asts[this.top - 1].nodeType ===
					TypeScript.NodeType.ModuleDeclaration &&
				(<TypeScript.ModuleDeclaration>this.asts[this.top - 1])
					.members == this.asts[this.top - 0] &&
				TypeScript.hasFlag(
					(<TypeScript.ModuleDeclaration>this.asts[this.top - 1])
						.modFlags,
					TypeScript.ModuleFlags.IsWholeFile,
		...
		public isBodyOfScript(): boolean {
			return (
				this.count() >= 2 &&
				this.asts[this.top - 1].nodeType ===
					TypeScript.NodeType.Script &&
				(<TypeScript.Script>this.asts[this.top - 1]).bod ==
					this.asts[this.top - 0]
			);
		}
		...
		public isBodyOfSwitch(): boolean {
			return (
				this.count() >= 2 &&
				this.asts[this.top - 1].nodeType ===
					TypeScript.NodeType.Switch &&
				(<TypeScript.SwitchStatement>this.asts[this.top - 1])
					.caseList == this.asts[this.top - 0]
			);
		}
		...
		public isBodyOfClass(): boolean {
			return (
				...
				this.asts[this.top - 1].nodeType ===
					TypeScript.NodeType.ClassDeclaration &&
				(<TypeScript.ClassDeclaration>this.asts[this.top - 1])
					.members == this.asts[this.top - 0]
			);
		}
		...
		public isBodyOfFunction(): boolean {
			return (
				...
				this.asts[this.top - 1].nodeType ===
					TypeScript.NodeType.FuncDecl &&
				(<TypeScript.FuncDecl>this.asts[this.top - 1]).bod ==
					this.asts[this.top - 0]
			);
		}
		...
		public isBodyOfInterface(): boolean {
			return (
				...
				this.asts[this.top - 1].nodeType ===
					TypeScript.NodeType.InterfaceDeclaration &&
				(<TypeScript.InterfaceDeclaration>this.asts[this.top - 1])
					.members == this.asts[this.top - 0]
			);
		}
		...
		public isBodyOfBlock(): boolean {
			return (
				this.count() >= 2 &&
				this.asts[this.top - 1].nodeType ===
					TypeScript.NodeType.Block &&
				(<TypeScript.Block>this.asts[this.top - 1]).statements ==
					this.asts[this.top - 0]
			);
		}
		...
		public isBodyOfFor(): boolean {
			return (
				...
				(<TypeScript.ForStatement>this.asts[this.top - 1]).body ==
					this.asts[this.top - 0]
			);
		}
		...
		public isBodyOfCase(): boolean {
			return (
				...
				(<TypeScript.CaseStatement>this.asts[this.top - 1]).body ==
					this.asts[this.top - 0]
			);
		}
		...
		public isBodyOfTry(): boolean {
			return (
				...
				(<TypeScript.Try>this.asts[this.top - 1]).body ==
					this.asts[this.top - 0]
			);
		}
		...
		public isBodyOfCatch(): boolean {
			return (
				this.count() >= 2 &&
				this.asts[this.top - 1].nodeType ===
					TypeScript.NodeType.Catch &&
				(<TypeScript.Catch>this.asts[this.top - 1]).body ==
					this.asts[this.top - 0]
			);
		}
		...
		public isBodyOfDoWhile(): boolean {
			return (
				this.count() >= 2 &&
				this.asts[this.top - 1].nodeType ===
					TypeScript.NodeType.DoWhile &&
				(<TypeScript.DoWhileStatement>this.asts[this.top - 1]).body ==
					this.asts[this.top - 0]
			);
		}
		...
		public isBodyOfWhile(): boolean {
			return (
				this.count() >= 2 &&
				this.asts[this.top - 1].nodeType ===
					TypeScript.NodeType.While &&
				(<TypeScript.WhileStatement>this.asts[this.top - 1]).body ==
					this.asts[this.top - 0]
			);
		}
		...
		public isBodyOfForIn(): boolean {
			return (
				this.count() >= 2 &&
				this.asts[this.top - 1].nodeType ===
					TypeScript.NodeType.ForIn &&
				(<TypeScript.ForInStatement>this.asts[this.top - 1]).body ==
					this.asts[this.top - 0]
			);
		}
		...
		public isBodyOfWith(): boolean {
			return (
				...
				(<TypeScript.WithStatement>this.asts[this.top - 1]).body ==
					this.asts[this.top - 0]
			);
		}
		...
		public isBodyOfFinally(): boolean {
			return (
				...
				(<TypeScript.Finally>this.asts[this.top - 1]).body ==
					this.asts[this.top - 0]
			);
		}
		...
		public isCaseOfSwitch(): boolean {
			return (
				...
				this.asts[this.top - 2].nodeType ===
					TypeScript.NodeType.Switch &&
				this.asts[this.top - 1].nodeType === TypeScript.NodeType.List &&
				(<TypeScript.SwitchStatement>this.asts[this.top - 2])
					.caseList == this.asts[this.top - 1]
			);
		}
		...
		public isDefaultCaseOfSwitch(): boolean {
			return (
				...
				(<TypeScript.SwitchStatement>this.asts[this.top - 2])
					.caseList == this.asts[this.top - 1] &&
				(<TypeScript.SwitchStatement>this.asts[this.top - 2])
					.defaultCase == this.asts[this.top - 0]
			);
		}
		...
		public isListOfObjectLit(): boolean {
			return (
				this.count() >= 2 &&
				this.asts[this.top - 1].nodeType ===
					TypeScript.NodeType.ObjectLit &&
				this.asts[this.top - 0].nodeType === TypeScript.NodeType.List &&
				(<TypeScript.UnaryExpression>this.asts[this.top - 1]).operand ==
					this.asts[this.top - 0]
			);
		}
		...
		public isEmptyListOfObjectLit(): boolean {
			return (
				...
				(<TypeScript.UnaryExpression>this.asts[this.top - 1]).operand ==
					this.asts[this.top - 0] &&
				(<TypeScript.ASTList>this.asts[this.top - 0]).members.length ==
					0
			);
		}
		...
		public isMemberOfObjectLit(): boolean {
			return (
				...
				this.asts[this.top - 2].nodeType ===
					TypeScript.NodeType.ObjectLit &&
				this.asts[this.top - 1].nodeType === TypeScript.NodeType.List &&
				this.asts[this.top - 0].nodeType ===
					TypeScript.NodeType.Member &&
				(<TypeScript.UnaryExpression>this.asts[this.top - 2]).operand ==
					this.asts[this.top - 1]
			);
		}
		...
		public isTargetOfMember(): boolean {
			return (
				...
				this.asts[this.top - 1].nodeType ===
					TypeScript.NodeType.Member &&
				(<TypeScript.BinaryExpression>this.asts[this.top - 1])
					.operand1 === this.asts[this.top - 0]
			);
		}
		...
		public isThenOfIf(): boolean {
			return (
				...
				(<TypeScript.IfStatement>this.asts[this.top - 1]).thenBod ==
					this.asts[this.top - 0]
			);
		}
		...
		public isElseOfIf(): boolean {
			return (
				this.count() >= 2 &&
				this.asts[this.top - 1].nodeType === TypeScript.NodeType.If &&
				(<TypeScript.IfStatement>this.asts[this.top - 1]).elseBod ==
					this.asts[this.top - 0]
			);
		}
		...
		public isArgumentListOfFunction(): boolean {
			return (
				...
				this.asts[this.top - 1].nodeType ===
					TypeScript.NodeType.FuncDecl &&
				(<TypeScript.FuncDecl>this.asts[this.top - 1]).arguments ===
					this.asts[this.top - 0]
			);
		}
		...
		public isArgumentListOfCall(): boolean {
			return (
				...
				(<TypeScript.CallExpression>this.asts[this.top - 1])
					.arguments === this.asts[this.top - 0]
			);
		}
		...
		public isSynthesizedBlock(): boolean {
			return (
				...
				this.asts[this.top - 0].nodeType ===
					TypeScript.NodeType.Block &&
				(<TypeScript.Block>this.asts[this.top - 0]).isStatementBlock ===
					false
			);
		}
	}
	...
	///
	export function getAstPathToPosition(
		...
		var pre = function (
			...
			if (isValidAstNode(cur)) {
				...
				if (pos >= minChar && pos < limChar) {
					...
					if (
						previous == null ||
						(cur.minChar >= previous.minChar &&
							cur.limChar <= previous.limChar)
					) {
						ctx.path.push(cur);
					} else {
	...
	//
	export function getTokenizationOffset(
