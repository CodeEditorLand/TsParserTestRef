...
declare function foo18(a: {
	(x: { (a: number): number; (a: string): string }): any[];
	(x: { (a: boolean): boolean; (a: Date): Date }): any[];
}): typeof a;
...
var r7arg1 =
	<T extends Base, U extends Derived>(x: (arg: T) => U) =>
	(r: T) =>
		<U>null;
...
var r8arg1 =
	<T extends Base, U extends Derived>(x: (arg: T) => U, y: (arg2: T) => U) =>
	(r: T) =>
		<U>null;
var r8arg2 =
...
var r11arg2 = (x: { foo: string }, y: { foo: string; bar: string }) =>
	<Base>null;
var r11 = foo11(r11arg1); // any
var r11a = [r11arg1, r11arg2];
var r11b = [r11arg2, r11arg1];

var r12arg1 = <T extends Array<Base>>(x: Array<Base>, y: T) =>
	<Array<Derived>>null;
