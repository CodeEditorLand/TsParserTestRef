...
let specifiedToSpecified: (this: { y: number }, x: number) => number =
	explicitStructural;
...
let unspecifiedLambdaToSpecified: (this: { y: number }, x: number) => number =
	unspecifiedLambda;
let specifiedLambdaToSpecified: (this: { y: number }, x: number) => number =
	specifiedLambda;
